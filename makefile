...
mem‐sim: main.o simulator.o mem_sim.o task_structure.o mem_sim_fifo.o mem_sim_lru.o
	cd build && g++ main.o simulator.o task_structure.o mem_sim.o mem_sim_lru.o mem_sim_fifo.o -o ../mem‐sim

main.o: main.cpp simulator.h simulator.o mem_sim_lru.o
...
run: mem‐sim
	./mem‐sim 5000 10000 lru data/sche_traces_small.txt 
